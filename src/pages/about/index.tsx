...
export default function About() {
  ...
  return (
    ...
    <div className='bg-my-subbrand px-3 p-1 scroll-py-1 font-bold text-2xl'>
        ...
        <p>
皆様、こんにちは。<br />
昭和35年創業の東栄特殊鋼材と申します。<br />
ハイス鋼をはじめとする特殊鋼からステンレス、普通鋼、非鉄、一般鋼材など様々な鋼種を扱っております。<br />
<br />
弊社は創業以来、一貫してハガネを生業として社歴を刻んで参りました。<br />
<br />

これも偏に、世界に誇る匠の技を持つ、<br />
数多くのお客様から頂きましたご愛顧の賜物と深く感謝申し上げます。<br />
<br />

これからも、お客様にご満足、ご信頼頂ける様、培われたノウハウを活かし、幅広い分野で多様なニーズにお応えできる会社を目指して精進して参ります。<br />
<br />

今後とも、倍旧のご指導ご鞭撻を賜りますよう、お願い申し上げます。<br />
<br />
...
<table className="table-fixed border-collapse">
  <thead>
    <tr>
      <th className="border bg-my-accent" colSpan={2}>会社情報</th>
    </tr>
  </thead>
  <tbody>
    <tr>
    ...
    <tr>
        ...
        <td className="border">〒132-0022 東京都江戸川区大杉3丁目15番13号</td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td className="border">NCバンドソー 2台<br/>
        バンドソー 2台<br/>
        CNC超硬切断機 1台<br/>
        クレーン 2.8t 1台<br/>
        クレーン 2t 1台</td>
